...
// #test1-3 요소가 클릭되었을 때 배경색을 빨간색으로 변경
...
test2.addEventListener("click", function () {
    ...
    if (test2.style.opacity == 0) {
        test2.style.opacity = 1; // 다시 불투명하기 변경
    }
})
...
/* 
    요구사항
    1. input에 작성한 배경색 "Enter"입력 시 적용
    2. 배경 div 클릭 시 alert 창에 해당 배경색 출력
    3. 표준 이벤트 모델 사용
*/
...
box3.addEventListener("click", function (e) {
    if (this.style.backgroundColor == '') {
        ...
        // alert(box3.style.backgroundColor);
