...
function classTest() {
    ...
    // divs 0, 1, 2 번째 요소에 각각 배경색 변경하기
    divs[0].style.backgroundColor = "rgb(114,203,80)";
    divs[1].style.backgroundColor = "rgb(159, 49, 223)";
    divs[1].style.borderRadius = "20px";
    divs[2].style.backgroundColor = "rgb(231, 222, 93)";
    divs[2].style.borderRadius = "50px";
}
...
function nameTest() {
    ...
    for(let i = 0; i<hobbyList.length; i++) {
        ...
        // input요소.checked = false; -> 해당 요소를 체크해제 하겠다.
    ...
    // 요소.innerText
    // 텍스트 내용만 요소 콘텐츠 내부에 출력함(HTML 코드로 해석하지 않음)
...
function cssTest() {
    ...
    div2.innerText = "querySelector는 첫번째 요소에만 속성을 적용함";

    // container.innerText = "CSS 선택자로 선택해서 값 변경됨";
